...
<form action="" method="post" enctype="multipart/form-data">
	@csrf
	<select name="ctgid" class="form-control" style="width: 100%; font-size: 16px; font-weight: bold;">
		<option selected>-----Chọn hạng mục-----</option>
		@foreach(DB::table('categories')->get() as $ctg)
		<option value="{{$ctg->id}}" >{{$ctg->hang_muc}}</option>
		@endforeach
	</select>
	<input style="width: 100%" type="text" name="idolname" placeholder="nhập tên idol" class="form-control">
